...
<div id="container">
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap" href="send_money.php">Money Transfer</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px black;  padding:20px 0px 20px 0px;">
            <h1 style=" color:white;"><b>Services</b></h1>
            <div class="container" >
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#34; color:white; width: 90%;  padding:20px 10px 20px 10px;">
                            <i class=""></i><br><br>
                            
                            <a href="all_cust.php"><button type="button" class="btn btn-outline-light mybtn">View
                                    Customers</button></a><br>
                            <h6>Customers of the bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            style="background-color:#34; color:white; width: 90%; border-radius:30px;  padding:20px 10px 20px 10px;">
                            <i class=""></i><br><br>
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6>Click above to tranfer money.</h6>
                        </div>
                    </div>
                    <div class="">
                        <div
